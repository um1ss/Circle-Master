...
public class ParticlesManager1VS1 : MonoBehaviour
{
    ...
    private void Awake()
    {
        EventBus1VS1.Instance.UserOneEarnedPoint += PlayOneShotWow;
        EventBus1VS1.Instance.UserTwoEarnedPoint += PlayOneShotWow;
        EventBus1VS1.Instance.StartParticles += PlayOneShotItemSparklePurple;
    }
